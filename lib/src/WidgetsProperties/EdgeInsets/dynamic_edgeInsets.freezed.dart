...
part of 'dynamic_edgeInsets.dart';
...
DynamicEdgeInsets _$DynamicEdgeInsetsFromJson(Map<String, dynamic> json) {
  return _DynamicEdgeInsets.fromJson(json);
}

/// @nodoc
mixin _$DynamicEdgeInsets {
...
class __$$DynamicEdgeInsetsImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$DynamicEdgeInsetsImpl(
      left: freezed == left
          ? _value.left
          : left // ignore: cast_nullable_to_non_nullable
              as double?,
...
class _$DynamicEdgeInsetsImpl implements _DynamicEdgeInsets {
  ...
  @override
  String toString() {
    return 'DynamicEdgeInsets(left: $left, top: $top, right: $right, bottom: $bottom)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DynamicEdgeInsetsImpl &&
  ...
  Map<String, dynamic> toJson() {
    return _$$DynamicEdgeInsetsImplToJson(
      this,
    );
  }
}
