...
part of 'dynamic_materialColor.dart';
...
DynamicMaterialColor _$DynamicMaterialColorFromJson(Map<String, dynamic> json) {
  return _DynamicMaterialColor.fromJson(json);
}

/// @nodoc
mixin _$DynamicMaterialColor {
...
class __$$DynamicMaterialColorImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$DynamicMaterialColorImpl(
      primary: null == primary
          ? _value.primary
          : primary // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$DynamicMaterialColorImpl implements _DynamicMaterialColor {
  const _$DynamicMaterialColorImpl(
  ...
  @override
  String toString() {
    return 'DynamicMaterialColor(primary: $primary, shade50: $shade50, shade100: $shade100, shade200: $shade200, shade300: $shade300, shade400: $shade400, shade500: $shade500, shade600: $shade600, shade700: $shade700, shade800: $shade800, shade900: $shade900)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$DynamicMaterialColorImplToJson(
      this,
    );
  }
}

abstract class _DynamicMaterialColor implements DynamicMaterialColor {
  const factory _DynamicMaterialColor(
