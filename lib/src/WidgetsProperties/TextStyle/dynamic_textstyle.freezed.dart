...
DynamicTextStyle _$DynamicTextStyleFromJson(Map<String, dynamic> json) {
  return _DynamicTextStyle.fromJson(json);
}

/// @nodoc
mixin _$DynamicTextStyle {
  ...
  DynamicFontWeight? get fontWeight => throw _privateConstructorUsedError;
...
class __$$DynamicTextStyleImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$DynamicTextStyleImpl(
      inherit: null == inherit
          ? _value.inherit
          : inherit // ignore: cast_nullable_to_non_nullable
              as bool,
...
/// @nodoc
@JsonSerializable()
class _$DynamicTextStyleImpl implements _DynamicTextStyle {
  const _$DynamicTextStyleImpl(
      {this.inherit = true,
      this.color,
  ...
  @override
  final DynamicFontWeight? fontWeight;
  @override
  ...
  Map<String, dynamic> toJson() {
    return _$$DynamicTextStyleImplToJson(
      this,
    );
  }
}

abstract class _DynamicTextStyle implements DynamicTextStyle {
  const factory _DynamicTextStyle(
      {final bool inherit,
      final String? color,
      final String? backgroundColor,
      final String? styleFromTheme,
  ...
  double? get fontSize;
  @override
  DynamicFontWeight? get fontWeight;
  @override
