...
DynamicTextField _$DynamicTextFieldFromJson(Map<String, dynamic> json) {
  return _DynamicTextField.fromJson(json);
}

/// @nodoc
mixin _$DynamicTextField {
  ...
  @JsonKey(ignore: true)
  $DynamicTextFieldCopyWith<DynamicTextField> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DynamicTextFieldCopyWith<$Res> {
  factory $DynamicTextFieldCopyWith(
          DynamicTextField value, $Res Function(DynamicTextField) then) =
      _$DynamicTextFieldCopyWithImpl<$Res, DynamicTextField>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DynamicTextFieldCopyWithImpl<$Res, $Val extends DynamicTextField>
    implements $DynamicTextFieldCopyWith<$Res> {
  _$DynamicTextFieldCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DynamicTextFieldImplCopyWith<$Res>
    implements $DynamicTextFieldCopyWith<$Res> {
  factory _$$DynamicTextFieldImplCopyWith(_$DynamicTextFieldImpl value,
          $Res Function(_$DynamicTextFieldImpl) then) =
      __$$DynamicTextFieldImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {DynamicInputDecoration? decoration,
...
/// @nodoc
class __$$DynamicTextFieldImplCopyWithImpl<$Res>
    extends _$DynamicTextFieldCopyWithImpl<$Res, _$DynamicTextFieldImpl>
    implements _$$DynamicTextFieldImplCopyWith<$Res> {
  __$$DynamicTextFieldImplCopyWithImpl(_$DynamicTextFieldImpl _value,
      $Res Function(_$DynamicTextFieldImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DynamicTextFieldImpl(
      decoration: freezed == decoration
          ? _value.decoration
          : decoration // ignore: cast_nullable_to_non_nullable
              as DynamicInputDecoration?,
...
/// @nodoc
@JsonSerializable()
class _$DynamicTextFieldImpl implements _DynamicTextField {
  const _$DynamicTextFieldImpl(
      {this.decoration,
      this.initialValue = '',
      this.keyboardType,
  ...
  factory _$DynamicTextFieldImpl.fromJson(Map<String, dynamic> json) =>
      _$$DynamicTextFieldImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DynamicTextFieldImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DynamicTextFieldImplCopyWith<_$DynamicTextFieldImpl> get copyWith =>
      __$$DynamicTextFieldImplCopyWithImpl<_$DynamicTextFieldImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DynamicTextFieldImplToJson(
      this,
    );
  }
}

abstract class _DynamicTextField implements DynamicTextField {
  const factory _DynamicTextField(
          {final DynamicInputDecoration? decoration,
          final String initialValue,
          final DynamicTextInputType? keyboardType,
          final TextInputAction? textInputAction,
  ...
  factory _DynamicTextField.fromJson(Map<String, dynamic> json) =
      _$DynamicTextFieldImpl.fromJson;
