...
DynamicCircleAvatar _$DynamicCircleAvatarFromJson(Map<String, dynamic> json) {
  return _DynamicCircleAvatar.fromJson(json);
}

/// @nodoc
mixin _$DynamicCircleAvatar {
  ...
  @JsonKey(ignore: true)
  $DynamicCircleAvatarCopyWith<DynamicCircleAvatar> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DynamicCircleAvatarCopyWith<$Res> {
  factory $DynamicCircleAvatarCopyWith(
          DynamicCircleAvatar value, $Res Function(DynamicCircleAvatar) then) =
      _$DynamicCircleAvatarCopyWithImpl<$Res, DynamicCircleAvatar>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DynamicCircleAvatarCopyWithImpl<$Res, $Val extends DynamicCircleAvatar>
    implements $DynamicCircleAvatarCopyWith<$Res> {
  _$DynamicCircleAvatarCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DynamicCircleAvatarImplCopyWith<$Res>
    implements $DynamicCircleAvatarCopyWith<$Res> {
  factory _$$DynamicCircleAvatarImplCopyWith(_$DynamicCircleAvatarImpl value,
          $Res Function(_$DynamicCircleAvatarImpl) then) =
      __$$DynamicCircleAvatarImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {Map<String, dynamic>? child,
...
/// @nodoc
class __$$DynamicCircleAvatarImplCopyWithImpl<$Res>
    extends _$DynamicCircleAvatarCopyWithImpl<$Res, _$DynamicCircleAvatarImpl>
    implements _$$DynamicCircleAvatarImplCopyWith<$Res> {
  __$$DynamicCircleAvatarImplCopyWithImpl(_$DynamicCircleAvatarImpl _value,
      $Res Function(_$DynamicCircleAvatarImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DynamicCircleAvatarImpl(
      child: freezed == child
          ? _value._child
          : child // ignore: cast_nullable_to_non_nullable
              as Map<String, dynamic>?,
...
/// @nodoc
@JsonSerializable()
class _$DynamicCircleAvatarImpl implements _DynamicCircleAvatar {
  const _$DynamicCircleAvatarImpl(
  ...
  factory _$DynamicCircleAvatarImpl.fromJson(Map<String, dynamic> json) =>
      _$$DynamicCircleAvatarImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DynamicCircleAvatarImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DynamicCircleAvatarImplCopyWith<_$DynamicCircleAvatarImpl> get copyWith =>
      __$$DynamicCircleAvatarImplCopyWithImpl<_$DynamicCircleAvatarImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DynamicCircleAvatarImplToJson(
      this,
    );
  }
}

abstract class _DynamicCircleAvatar implements DynamicCircleAvatar {
  const factory _DynamicCircleAvatar(
      {final Map<String, dynamic>? child,
      final String? backgroundColor,
      final String? backgroundImage,
      final String? foregroundImage,
      ...
      final double? radius,
      final double? minRadius,
      final double? maxRadius}) = _$DynamicCircleAvatarImpl;

  factory _DynamicCircleAvatar.fromJson(Map<String, dynamic> json) =
      _$DynamicCircleAvatarImpl.fromJson;
