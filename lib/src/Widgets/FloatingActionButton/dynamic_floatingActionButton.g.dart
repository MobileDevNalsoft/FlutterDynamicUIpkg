...
_$DynamicFloatingActionButtonImpl _$$DynamicFloatingActionButtonImplFromJson(
        Map<String, dynamic> json) =>
    _$DynamicFloatingActionButtonImpl(
      onPressed: json['onPressed'] as String?,
      textStyle: json['textStyle'] == null
          ? null
          : DynamicTextStyle.fromJson(json['textStyle']),
      ...
      extendedTextStyle: json['extendedTextStyle'] == null
          ? null
          : DynamicTextStyle.fromJson(json['extendedTextStyle']),
...
Map<String, dynamic> _$$DynamicFloatingActionButtonImplToJson(
        _$DynamicFloatingActionButtonImpl instance) =>
    <String, dynamic>{
